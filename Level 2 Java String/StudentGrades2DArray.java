...
public class StudentGrades2DArray {
    ...
    // Create a method that generate 2 digit random marks for all the students in 2D
    // array
    ...
    // Create the method that print the marks of subject with percentage and grades
    public void displayStudentDetails(int[][] marks, double[] percentages, char[] grades, int numStudents) {
        System.out.println("\nResults:");
    ...
    public static void main(String[] args) {
        ...
        // Create a 2D array to store marks for Physics, Chemistry, and Maths for each
        // student by the help of the generateRandomMarks method
        int[][] marks = StudentGrades2DArray.generateRandomMarks(numStudents); // 3 subjects for each student

        double[] percentages = StudentGrades2DArray.calculatePercentage(numStudents, marks); // To store percentage for
                                                                                             // each student
        char[] grades = StudentGrades2DArray.calculateGrade(percentages, numStudents); // To store grade for each
                                                                                       // student

        // Display the results
        StudentGrades2DArray.displayStudentDetails(marks, percentages, grades, numStudents);

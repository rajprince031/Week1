...
public class SplitInToWordsAndFindLength{
    
    public static void main(String[] agrs){

        //Create the object of the the class SplitAndFindLength
        SplitInToWordsAndFindLength SplitInToWordsAndFindLength = new SplitInToWordsAndFindLength();
        ...
        int length = SplitInToWordsAndFindLength.calculateLength(str);

        //Create a string array that store the word and length of word that return by splitString method
        String[][] stringArray = SplitInToWordsAndFindLength.splitString(str,length);
        
        //Take a loop to print all the words and its length
